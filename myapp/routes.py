...
df_backend_fp = pd.read_excel(r"C:\Users\Rajesab\Downloads\Sample_Input_Output copy 2 1.xlsx") # dataframe to represent all the data regarding the queries in the backend
